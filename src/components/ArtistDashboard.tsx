    ...
    <div className="pb-24">
      ...
      <div className="flex flex-col gap-4 mb-6 px-4 pt-4">
        <div className="min-w-0">
          <h1 className="text-2xl font-display font-semibold text-ink">Meri Calendar</h1>
          <p className="mt-1 text-xs text-ink3">
            Jis din aap free hain, us date par tap karein. Green = available.
          </p>
          {profile?.category && (
            <span className="chip-sv mt-2 text-xs inline-block">{profile.category}</span>
          )}
        </div>
      </div>
